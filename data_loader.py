...
def train_data_balancing(data_path, img_size,class_list):
    label_list = []
    img_list = []
    label_idx = 0

    #class_list = [0]*num_classes # class마다 이미지가 뽑혔을 때, 증가되는 수를 담기 위한 리스트
    ...
    print("class_list_len : " + str(len(class_list)))
    #print("class_list : " + str(class_list))
    return img_list,label_list,class_list
